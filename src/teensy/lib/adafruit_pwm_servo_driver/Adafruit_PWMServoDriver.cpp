 ...
 * TwoWire interface
 */
Adafruit_PWMServoDriver::Adafruit_PWMServoDriver() : _i2caddr(PCA9685_I2C_ADDRESS), _i2c(&Wire) {
}
 ...
 */
Adafruit_PWMServoDriver::Adafruit_PWMServoDriver(const uint8_t addr) : _i2caddr(addr), _i2c(&Wire) {
}
