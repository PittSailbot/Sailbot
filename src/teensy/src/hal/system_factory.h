...
#define NOPIN 255
    ...
    gps->begin() ? Serial.println("I: Started PA1010D GPS over UART")
                 : Serial.println("E: Failed to start PA1010D GPS over UART");
#else
    gps = std::make_unique<PA1010D_GPS>();
    gps->begin() ? Serial.println("I: Started PA1010D GPS over I2C")
                 : Serial.println("E: Failed to start PA1010D GPS over I2C");
#endif
#endif
#endif
