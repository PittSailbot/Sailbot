...
class camera():
    ...
    def color_filter(self):
        ...
        if real:
            ...
            cv2.putText(self.frame, "TARGET OUTPUT: " + str(x + (w / 2))     , (10, 54), cv2.FONT_HERSHEY_PLAIN, 1, (0, 0, 0)  , 2)  # TARGET cords
            cv2.putText(self.frame, self.find_side(self.vid_feed, x + (w / 2))         , (10, 71), cv2.FONT_HERSHEY_PLAIN, 1, (0, 0, 255), 2)  # TARGET output

        else:
            cv2.putText(self.frame, "NO CONTOURS", (10, 20), cv2.FONT_HERSHEY_PLAIN, 1, (255, 255, 255), 2)  # area of max
