...
data_files.append(
    ("lib/python3.8/site-packages/sailbot/events/", glob(package_name + "/events/*.py"))
)
data_files.append(
    (
        "lib/python3.8/site-packages/sailbot/virtualPeripherals/",
        glob(package_name + "/virtualPeripherals/*.py"),
    )
)
data_files.append(
    (
        "lib/python3.8/site-packages/sailbot/peripherals/",
        glob(package_name + "/peripherals/*.py"),
    )
)
data_files.append(
    ("lib/python3.8/site-packages/sailbot/CV/", glob(package_name + "/CV/*"))
)

data_files.append(
    (
        "lib//python3.8/site-packages/sailbot/website/",
        glob(package_name + "/website/*.py"),
    )
)
data_files.append(
    (
        "lib//python3.8/site-packages/sailbot/website/templates/",
        glob(package_name + "/website/templates/*"),
    )
)
data_files.append(
    (
...
data_files.append(
    (
        "lib//python3.8/site-packages/sailbot/website/static/js/",
        glob(package_name + "/website/static/js/*"),
    )
)
data_files.append(
    (
